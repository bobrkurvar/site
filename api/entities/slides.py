...
from adapters.images import generate_slides, SlideImagesManager
...
async def insert_slide_image(images: Annotated[list[UploadFile], File()]):
    ...
    await add_slides(images_bytes, generate_images=generate_slides, file_manager=SlideImagesManager())
