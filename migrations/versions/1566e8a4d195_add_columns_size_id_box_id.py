...
def upgrade() -> None:
    ...
    op.execute(sa.text("ALTER TABLE tile_sizes DROP CONSTRAINT tile_sizes_pkey CASCADE"))
    ...
    op.add_column(
        "catalog",
        sa.Column("tile_size_id", sa.Integer, nullable=True)
    )
    op.add_column(
        "catalog",
