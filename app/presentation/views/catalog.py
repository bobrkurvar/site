...
async def get_catalog_tiles_page(
    ...
    collections, tiles, tile_sizes, tile_colors, total_count = await fetch_tiles(manager, filters, limit, offset)
...
async def get_catalog_tiles_page(
    ...
    collections, tiles, tile_sizes, tile_colors, total_count = await fetch_tiles(manager, filters, limit, offset, Types.get_category_from_slug(category))
